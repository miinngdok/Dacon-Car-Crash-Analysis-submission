...
ann_file_train = '../data/mmaction_ego/train_ego_whole.txt'
ann_file_val = '../data/mmaction_ego/train_ego_whole.txt'
ann_file_test = '../data/mmaction_ego/train_ego_whole.txt'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type='VideoDataset',
        ann_file='../data/mmaction_ego/train_ego_whole.txt',
        pipeline=[
            dict(type='DecordInit'),
            dict(
                type='SampleFrames',
...
optimizer_config = dict(
    ...
    bucket_size_mb=-1,
    use_fp16=True)
work_dir = './work_dirs/swin_base_ego_final'
gpu_ids = range(0, 1)
omnisource = False
module_hooks = []
